...
#undef YBWLIB2_DYNAMIC_TYPE_REALINIT_CLASS

#undef YBWLIB2_DYNAMIC_TYPE_REALINIT_CLASS_NOBASE

#undef YBWLIB2_DYNAMIC_TYPE_REALINIT_CLASS_PLACEMENT1

#undef YBWLIB2_DYNAMIC_TYPE_REALINIT_CLASS_NOBASE_PLACEMENT1

#undef YBWLIB2_DYNAMIC_TYPE_REALINIT_CLASS_PLACEMENT2

#undef YBWLIB2_DYNAMIC_TYPE_REALINIT_CLASS_NOBASE_PLACEMENT2

#undef YBWLIB2_DYNAMIC_TYPE_REALINIT_CLASS_PLACEMENT3

#undef YBWLIB2_DYNAMIC_TYPE_REALINIT_CLASS_NOBASE_PLACEMENT3

#undef YBWLIB2_DYNAMIC_TYPE_REALINIT_CLASS_PLACEMENT4

#undef YBWLIB2_DYNAMIC_TYPE_REALINIT_CLASS_NOBASE_PLACEMENT4

#undef YBWLIB2_DYNAMIC_TYPE_REALUNINIT_CLASS

#undef YBWLIB2_DYNAMIC_TYPE_REALUNINIT_CLASS_NOFREE
