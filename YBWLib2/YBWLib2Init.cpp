...
namespace YBWLib2 {
	...
	static SharedResourceInitializer& GetSharedResourceInitializer_YBWLib2_DLL() noexcept {
		static SharedResourceInitializer sharedresourceinitializer(&YBWLib2_RealInitDLL, &YBWLib2_RealUnInitDLL);
	...
	YBWLIB2_API void YBWLIB2_CALLTYPE YBWLib2_InitDLL() noexcept {
		GetSharedResourceInitializer_YBWLib2_DLL().Initialize();
	}

	YBWLIB2_API void YBWLIB2_CALLTYPE YBWLib2_UnInitDLL() noexcept {
		GetSharedResourceInitializer_YBWLib2_DLL().UnInitialize();
	}
}
