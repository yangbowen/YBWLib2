...
namespace YBWLib2 {
	...
	void YBWLIB2_CALLTYPE JSON_RealInitModuleLocal() noexcept {
		GetDynamicTypeClassObject<IJSONException>()->RegisterTypeInfoWrapper(wrapper_type_info_t(typeid(IJSONException)), module_info_current);
		GetDynamicTypeClassObject<IParseErrorJSONException>()->RegisterTypeInfoWrapper(wrapper_type_info_t(typeid(IParseErrorJSONException)), module_info_current);
		...
		GetDynamicTypeClassObject<JSONException>()->RegisterTypeInfoWrapper(wrapper_type_info_t(typeid(JSONException)), module_info_current);
		GetDynamicTypeClassObject<ParseErrorJSONException>()->RegisterTypeInfoWrapper(wrapper_type_info_t(typeid(ParseErrorJSONException)), module_info_current);
	}

	void YBWLIB2_CALLTYPE JSON_RealUnInitModuleLocal() noexcept {
		GetDynamicTypeClassObject<JSONException>()->UnRegisterTypeInfoWrapper(module_info_current);
		GetDynamicTypeClassObject<ParseErrorJSONException>()->UnRegisterTypeInfoWrapper(module_info_current);
		...
		GetDynamicTypeClassObject<IJSONSAXGenerator>()->UnRegisterTypeInfoWrapper(module_info_current);
		GetDynamicTypeClassObject<IJSONSAXHandler>()->UnRegisterTypeInfoWrapper(module_info_current);
		GetDynamicTypeClassObject<IParseErrorJSONException>()->UnRegisterTypeInfoWrapper(module_info_current);
		GetDynamicTypeClassObject<IJSONException>()->UnRegisterTypeInfoWrapper(module_info_current);
	}
}
